...
/**
 * Certificates — company documents and registrations shown as image scans.
 */
export const certificates: Certificate[] = [
  {
    ...
    description_ar: "أمر شراء رسمي يوضح متطلبات الأعمال والتوريد.",
    description_en: "Official purchase order and work requirements document.",
    issuer_ar: "شركة أكوا ديناميك للميكانيكيات الكهروميكانيكية",
    issuer_en: "Aqua Dynamic Electromechanical LLC",
    year: "2026",
    image_url: "/certificates/01.png",
    alt_text_ar: "أمر شراء",
    alt_text_en: "Purchase order",
    sort_order: 1,
    is_featured: true,
    is_active: true,
  },
  {
    id: "cert-2",
    title_ar: "نموذج تقديم التأهيل المسبق",
    title_en: "Prequalification Submission Form",
    description_ar: "نموذج تأهيل مسبق معتمد لأعمال الهياكل الفولاذية والتكسية.",
    description_en: "Approved prequalification submission for steel structure and cladding works.",
    issuer_ar: "شركة الخيال للهندسة الاستشارية",
    issuer_en: "Al Khail Engineering Consultants LLC",
    year: "2026",
    image_url: "/certificates/02.png",
    alt_text_ar: "نموذج تقديم التأهيل المسبق",
    alt_text_en: "Prequalification submission form",
    sort_order: 2,
    is_featured: true,
    is_active: true,
  },
  {
    id: "cert-3",
    title_ar: "نموذج اعتماد المواد",
    title_en: "Material Submittal Form",
    description_ar: "نموذج اعتماد المواد والمستندات الفنية الخاصة بالمشروع.",
    description_en: "Material approval and technical submittal document for project works.",
    issuer_ar: "شركة الماسة للهندسة المعمارية",
    issuer_en: "Al Massa Architecture",
    year: "2025",
    image_url: "/certificates/03.png",
    alt_text_ar: "نموذج اعتماد المواد",
    alt_text_en: "Material submittal form",
    sort_order: 3,
    is_featured: true,
    is_active: true,
  },
  {
    id: "cert-4",
    title_ar: "الرخصة الاقتصادية لأبوظبي",
    title_en: "Abu Dhabi Economic Licence",
    description_ar: "رخصة اقتصادية رسمية لشركة فالكون ديزاين للمقاولات العامة.",
    description_en: "Official economic licence for Falcon Design General Contracting.",
    issuer_ar: "دائرة التنمية الاقتصادية - أبوظبي",
    issuer_en: "Abu Dhabi Registration Authority",
    year: "2024",
    image_url: "/certificates/04.png",
    alt_text_ar: "الرخصة الاقتصادية لأبوظبي",
  ...
  {
    id: "cert-5",
    title_ar: "معلومات إضافية للرخصة الاقتصادية",
    title_en: "Economic Licence Additional Information",
    description_ar: "البيانات الإضافية المرتبطة بالرخصة الاقتصادية.",
    description_en: "Additional information associated with the economic licence.",
    issuer_ar: "دائرة التنمية الاقتصادية - أبوظبي",
    issuer_en: "Abu Dhabi Registration Authority",
    year: "2024",
    image_url: "/certificates/05.png",
    alt_text_ar: "معلومات إضافية للرخصة الاقتصادية",
    alt_text_en: "Economic licence additional information",
    sort_order: 5,
    is_featured: false,
    is_active: true,
  },
  {
    id: "cert-6",
    title_ar: "شهادة التسجيل في ضريبة القيمة المضافة",
    title_en: "VAT Registration Certificate",
    description_ar: "شهادة تسجيل فالكون ديزاين في ضريبة القيمة المضافة.",
    description_en: "Falcon Design registration certificate for value added tax.",
    issuer_ar: "الهيئة الاتحادية للضرائب",
    issuer_en: "Federal Tax Authority",
    year: "2023",
    image_url: "/certificates/06.png",
    alt_text_ar: "شهادة التسجيل في ضريبة القيمة المضافة",
  ...
  {
    id: "cert-7",
    title_ar: "تفاصيل التسجيل الضريبي",
    title_en: "Tax Registration Details",
    description_ar: "تفاصيل المنشأة والفروع المسجلة لدى الهيئة الاتحادية للضرائب.",
    description_en: "Registered entity and branch details from the Federal Tax Authority.",
    issuer_ar: "الهيئة الاتحادية للضرائب",
    issuer_en: "Federal Tax Authority",
    year: "2023",
    image_url: "/certificates/07.png",
    alt_text_ar: "تفاصيل التسجيل الضريبي",
    alt_text_en: "Tax registration details",
    sort_order: 7,
    is_featured: false,
    is_active: true,
  },
  {
    id: "cert-8",
    title_ar: "تفاصيل إضافية للتسجيل الضريبي",
    title_en: "Additional Tax Registration Details",
    description_ar: "صفحة إضافية من تفاصيل التسجيل لدى الهيئة الاتحادية للضرائب.",
    description_en: "Additional tax registration details from the Federal Tax Authority.",
    issuer_ar: "الهيئة الاتحادية للضرائب",
    issuer_en: "Federal Tax Authority",
    year: "2023",
    image_url: "/certificates/08.png",
    alt_text_ar: "تفاصيل إضافية للتسجيل الضريبي",
    alt_text_en: "Additional tax registration details",
    sort_order: 8,
    is_featured: false,
    is_active: true,
  },
  {
    id: "cert-9",
    title_ar: "شهادة التسجيل في ضريبة الشركات",
    title_en: "Corporate Tax Registration Certificate",
    description_ar: "شهادة تسجيل فالكون ديزاين في ضريبة الشركات بدولة الإمارات.",
    description_en: "Falcon Design corporate tax registration certificate in the UAE.",
    issuer_ar: "الهيئة الاتحادية للضرائب",
    issuer_en: "Federal Tax Authority",
    year: "2024",
    image_url: "/certificates/09.png",
    alt_text_ar: "شهادة التسجيل في ضريبة الشركات",
  ...
  {
    id: "cert-10",
    title_ar: "تفاصيل التسجيل في ضريبة الشركات",
    title_en: "Corporate Tax Registration Details",
    description_ar: "تفاصيل المنشأة والفترة الضريبية المسجلة لضريبة الشركات.",
    description_en: "Registered entity and tax period details for corporate tax.",
    issuer_ar: "الهيئة الاتحادية للضرائب",
    issuer_en: "Federal Tax Authority",
    year: "2024",
    image_url: "/certificates/10.png",
    alt_text_ar: "تفاصيل التسجيل في ضريبة الشركات",
    alt_text_en: "Corporate tax registration details",
    sort_order: 10,
    is_featured: false,
    is_active: true,
  },
  {
    id: "cert-11",
    title_ar: "بطاقة اعتماد التواقيع الإلكترونية",
    title_en: "Electronic Company Card",
    description_ar: "بطاقة اعتماد التواقيع الإلكترونية الخاصة بالشركة.",
    description_en: "Electronic company card for authorized signatures.",
    ...
    alt_text_ar: "بطاقة اعتماد التواقيع الإلكترونية",
    alt_text_en: "Electronic company card",
    sort_order: 11,
    is_featured: false,
    is_active: true,
  },
