 ...
 * Images live under /public (e.g. /gallery/*.jpeg, /certificates/*.svg).
 */
...
export const certificates: Certificate[] = [
  {
    id: "cert-1",
    title_ar: "شهادة الجودة ISO 9001",
    title_en: "ISO 9001 Quality Certificate",
    description_ar: "نظام إدارة الجودة وفق المواصفات الدولية.",
    description_en: "Quality management system aligned with international standards.",
    issuer_ar: "هيئة الاعتماد",
    issuer_en: "Accreditation Body",
    year: "2024",
    image_url: "/certificates/iso-quality.svg",
    alt_text_ar: "شهادة الجودة ISO 9001",
    alt_text_en: "ISO 9001 quality certificate",
    sort_order: 1,
    is_featured: true,
    is_active: true,
  },
  {
    id: "cert-2",
    title_ar: "شهادة السلامة المهنية",
    title_en: "Occupational Safety Certificate",
    description_ar: "التزام بمعايير السلامة في مواقع العمل والمشاريع.",
    description_en: "Commitment to workplace and project site safety standards.",
    issuer_ar: "إدارة السلامة",
    issuer_en: "Safety Authority",
    year: "2023",
    image_url: "/certificates/safety.svg",
    alt_text_ar: "شهادة السلامة المهنية",
    alt_text_en: "Occupational safety certificate",
    sort_order: 2,
    is_featured: true,
    is_active: true,
  },
  {
    id: "cert-3",
    title_ar: "رخصة المقاولات التجارية",
    title_en: "Trade Contracting License",
    description_ar: "ترخيص رسمي لمزاولة أعمال المقاولات العامة في الإمارات.",
    description_en: "Official license for general contracting works in the UAE.",
    issuer_ar: "دائرة التنمية الاقتصادية",
    issuer_en: "Department of Economic Development",
    year: "2019",
    image_url: "/certificates/trade-license.svg",
    alt_text_ar: "رخصة المقاولات التجارية",
    alt_text_en: "Trade contracting license",
    sort_order: 3,
    is_featured: true,
    is_active: true,
  },
  {
    id: "cert-4",
    title_ar: "شهادة تقدير عميل",
    title_en: "Client Appreciation Certificate",
    description_ar: "تقدير من عملاء استراتيجيين لجودة التنفيذ والالتزام.",
    description_en: "Recognition from strategic clients for delivery quality and commitment.",
    issuer_ar: "شركاء المشاريع",
    issuer_en: "Project Partners",
    year: "2024",
    image_url: "/certificates/appreciation.svg",
    alt_text_ar: "شهادة تقدير عميل",
    alt_text_en: "Client appreciation certificate",
    sort_order: 4,
    is_featured: false,
    is_active: true,
  },
